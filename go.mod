module github.com/your-org/chrome_skill
...
// x/tools ниже v0.49.0 не читает export data Go 1.27 — mockery падает на
// «package "context" without types»; сам mockery тянет v0.43.0.
